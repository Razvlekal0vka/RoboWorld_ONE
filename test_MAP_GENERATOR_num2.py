        ...
        for y in range(self.size_of_the_city):
            for x in range(self.size_of_the_city):
                ...
                if self.map_city[y][x][0] == 'wall_1':
                    ...
                    r, g, b = 84, 0, 138
                elif self.map_city[y][x][0] == 'dark_maze_floor_1' or self.map_city[y][x][0] == 'dark_maze_floor_2' or self.map_city[y][x][0] == 'dark_maze_floor_3' or self.map_city[y][x][0] == 'dark_maze_floor_4':
                    r, g, b = 155, 0, 255
...
map_lev = level.map_level()  # Считываем данные
